<%-- 
    Document   : view_item
    Created on : Oct 29, 2019, 3:52:14 PM
                        ...
                        <table border="1" >
                            <tbody>
                                ...
                                <%
                                    ...
                                    String q = "SELECT i_id, i_name, i_price, mmc.c_name FROM item_master im inner join manage_menu_category mmc on im.i_fall_category=mmc.c_id";
