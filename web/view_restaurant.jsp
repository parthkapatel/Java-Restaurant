<%-- 
    Document   : view_restaurant
    Created on : Oct 29, 2019, 3:27:43 PM
                        ...
                        <table border="1" >
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="updaterestaurant.jsp?id=<%= rs.getString(1)%>">Update</td>
                                    <td><a href="deleterestaurantservlet?id=<%= rs.getString(1)%>">Delete</td>
                                </tr>
                                <%
                                    }
                                    cn.close();
